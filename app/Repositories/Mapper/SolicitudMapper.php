    ...
    public function map($solicitud)
    {
        if(is_a($solicitud, 'Illuminate\Support\Collection'))
        {
            $solicitudes = $solicitud->map(function($solicitud){
                $solicitudMappeada = new \App\Domain\Solicitud($solicitud->IDS, $solicitud->MEDICO, $solicitud->FECHAS, $solicitud->ESTADO, $solicitud->ASIGNADO, $solicitud->EQUIVALENCIA, $solicitud->MOTIVO, $solicitud->ESPECIALIDAD, $solicitud->TIPO, $solicitud->FOTO, $solicitud->REVISADO, $solicitud->OBS);
