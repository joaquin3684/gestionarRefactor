...
class FarmaciaMapper
{
    ...
    {
        $farmacia = new \App\Domain\Farmacia($objeto->ID, $objeto->NOMBRE, $objeto->DIRECCION, $objeto->LOCALIDAD, $objeto->latitude, $objeto->longitude, $objeto->TELEFONO, $objeto->ZONA);
