...
class AppSolicitudController extends Controller
{
    ...
    {
        $dni = $request['dni'];
        return DB::select(DB::raw("SELECT Solicitudes.IDS, Solicitudes.TIPO, Solicitudes.MEDICO, Climed.NOMBRE AS CLINICA, Climed.DIRECCION, Especialidad.NOMBRE AS ESP, Turnos.MEDICOASIGNADO, Turnos.FECHAT, Turnos.HORAT,Turnos.MOTIVOT FROM (Solicitudes LEFT JOIN Turnos ON Solicitudes.IDS = Turnos.IDSOLICITUD) LEFT JOIN Climed ON Solicitudes.IDCLIMED = Climed.IDCLI LEFT JOIN Especialidad ON Solicitudes.ESPECIALIDAD = Especialidad.IDESPECIALIDAD WHERE Solicitudes.ESTADO='Confirmado' AND Solicitudes.IDAFILIADO = '$dni' AND Turnos.CONFIRMACION = 2 "));
    ...
    {
        $dni = $request['dni'];
        $prueba =  DB::select(DB::raw("SELECT Solicitudes.IDS, Solicitudes.TIPO, Solicitudes.MEDICO,Solicitudes.FECHAS,Climed.NOMBRE AS CLINICA,Climed.DIRECCION,Especialidad.NOMBRE AS ESP FROM Solicitudes LEFT JOIN Climed ON Solicitudes.IDCLIMED = Climed.IDCLI LEFT JOIN Especialidad ON Solicitudes.ESPECIALIDAD = Especialidad.IDESPECIALIDAD WHERE Solicitudes.ESTADO='Pendiente' OR Solicitudes.ESTADO='Abierto' AND Solicitudes.IDAFILIADO = '$dni'"));
        return $prueba;
    }
    ...
    {
        $dni = $request['dni'];
        return DB::select(DB::raw("SELECT Solicitudes.IDS, Solicitudes.TIPO, Solicitudes.MEDICO, Climed.NOMBRE AS CLINICA, Climed.DIRECCION, Especialidad.NOMBRE AS ESP, Turnos.MEDICOASIGNADO, Turnos.FECHAT, Turnos.HORAT,Turnos.MOTIVOT FROM (Solicitudes LEFT JOIN Turnos ON Solicitudes.IDS = Turnos.IDSOLICITUD) LEFT JOIN Climed ON Solicitudes.IDCLIMED = Climed.IDCLI LEFT JOIN Especialidad ON Solicitudes.ESPECIALIDAD = Especialidad.IDESPECIALIDAD WHERE Solicitudes.ESTADO='En espera' AND Solicitudes.IDAFILIADO = '$dni' AND Turnos.CONFIRMACION = 0 "));
    ...
    {
        $dni = $request['dni'];
        return DB::select(DB::raw("SELECT Solicitudes.IDS, Solicitudes.TIPO, Solicitudes.MEDICO,Solicitudes.FECHAS,Climed.NOMBRE AS CLINICA,Climed.DIRECCION,Especialidad.NOMBRE AS ESP FROM Solicitudes INNER JOIN Climed ON Solicitudes.IDCLIMED = Climed.IDCLI LEFT JOIN Especialidad ON Solicitudes.ESPECIALIDAD = Especialidad.IDESPECIALIDAD WHERE Solicitudes.ESTADO='Rechazado' AND Solicitudes.IDAFILIADO = '$dni'"));
    }
